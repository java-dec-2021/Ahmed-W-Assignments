package com.aw.mvc.controllers;
...
import com.aw.mvc.services.BookService;
...
public class BooksApi {
	...
	public Book create(@RequestParam(value="id") Long id, @RequestParam(value = "title") String title, @RequestParam(value = "description") String desc,
			@RequestParam(value = "language") String lang, @RequestParam(value = "pages") Integer numOfPages) {
